class Package < ActiveRecord::Base
  ...
  attr_accessible :access_id, :contributor, :coverage, :creator, :date, :description, :format_id, :language_id, :publisher, :relation, :retention_id, :rights, :source, :status, :title, :type_id, :what, :when, :where, :who, :subject_ids
